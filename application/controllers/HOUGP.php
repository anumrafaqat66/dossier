...
class HOUGP extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('hougp/dashboard');
        } else {
    ...
    public function PN_Form()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('hougp/pn_form1', $data);
        }
    }
    ...
    public function view_edit_personal_record($id = null)
    {
        ...
        $this->load->view('hougp/edit_personal_data', $data);
    }
    ...
    public function add_inspection_record()
    {
        if ($this->input->post()) {
            ...
            if (!empty($insert)) {
                $this->session->set_flashdata('success', 'Data Submitted successfully');
                redirect('HOUGP/Inspection_record');
            } else {
                $this->session->set_flashdata('failure', 'Something went wrong, try again.');
                redirect('HOUGP/Inspection_record');
            }
    ...
    public function update_inspection_record()
    {
        if ($this->input->post()) {
            ...
            if (!empty($insert)) {
                ...
                redirect('HOUGP/view_dossier_folder');
            } else {
                $this->session->set_flashdata('failure', 'Something went wrong, try again.');
                redirect('HOUGP/view_dossier_folder');
            }
        ...
        if ($this->input->post()) {
            ...
            if (!empty($update)) {
                ...
                if ($page == 'daily_module' || $page == 'update_punishment') {
                    redirect('HOUGP/view_punishment_list');
                } elseif ($page == 'dossier') {
                    redirect('HOUGP/view_dossier');
                }
            } else {
    ...
    public function save_cadet_observation()
    {
        if ($this->input->post()) {
            ...
            if (!empty($insert)) {
                ...
                redirect('HOUGP/add_observation');
            } else {
                $this->session->set_flashdata('failure', 'Something went wrong, try again.');
                redirect('HOUGP/add_observation');
            }
        ...
        if ($this->input->post()) {
            ...
            if (!empty($insert)) {
                if ($page == 'daily_module') {
                    ...
                    redirect('HOUGP/view_observation_list');
                } elseif ($page == 'dossier') {
                    $this->session->set_flashdata('success', 'Observation updated successfully');
                    redirect('HOUGP/view_dossier');
                } else {
    ...
    public function view_edit_officer_record($row_id = null)
    {
        ...
        $this->load->view('hougp/edit_officer_record', $data);
    }
    ...
    public function save_divisional_officer_records()
    {
        if ($this->input->post()) {
            ...
            if (!empty($insert)) {
                ...
                redirect('HOUGP/view_record_div_officer');
            } else {
                $this->session->set_flashdata('failure', 'Something went wrong, try again.');
                redirect('HOUGP/view_record_div_officer');
            }
    ...
    public function Inspection_record()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('hougp/inspection_record', $data);
        }
    }
    ...
    {
        if ($this->session->has_userdata('user_id')) {
            $this->load->view('hougp/psychologist_report');
        }
    }
    ...
    {
        if ($this->session->has_userdata('user_id')) {
            $this->load->view('hougp/biography');
        }
    }
    public function personal_data()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $data['divisions'] = $this->db->where('division_name', $this->session->userdata('division'))->get('divisions')->result_array();
            $this->load->view('hougp/personal_data', $data);
        }
    }
    ...
    public function view_dossier()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            // print_r($data);
            $this->load->view('hougp/view_dossier', $data);
        }
    }
    ...
    public function view_dossier_folder()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('hougp/view_dossier_folder', $data);
        }
    }
    ...
    public function add_club()
    {
        if ($this->session->has_userdata('user_id')) {
            $data['club_data'] = $this->db->get('cadet_club')->result_array();
            $this->load->view('hougp/add_club', $data);
        }
    }
    public function daily_module()
    {
        if ($this->session->has_userdata('user_id')) {
            $this->load->view('hougp/daily_module');
        }
    }
    public function add_punishment()
    {
        if ($this->session->has_userdata('user_id')) {
            $this->load->view('hougp/add_punishment');
        }
    }
    public function add_physical_milestone($page = null)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('hougp/add_physical_milestone', $data);
        }
    }
    public function add_excuse()
    {
        if ($this->session->has_userdata('user_id')) {
            $this->load->view('hougp/add_excuse'); //, $data);
        }
    }
    public function add_observation()
    {
        if ($this->session->has_userdata('user_id')) {
            $this->load->view('hougp/add_observation');
        }
    }
    public function add_observation_slip()
    {
        if ($this->session->has_userdata('user_id')) {
            $this->load->view('hougp/add_observation_slip');
        }
    }
    public function add_warning()
    {
        if ($this->session->has_userdata('user_id')) {
            $this->load->view('hougp/add_warning');
        }
    }
    public function add_officer_qualities()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('hougp/officer_like_qualities', $data);
        }
    }
    ...
    public function add_branch_allocation()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('hougp/branch_allocation', $data);
        }
    }
    public function save_branches_allocation()
    {
        if ($this->input->post()) {
            ...
            if (!empty($insert)) {
                ...
                redirect('HOUGP/add_branch_allocation');
            } else {
                $this->session->set_flashdata('failure', 'Something went wrong, try again.');
                redirect('HOUGP/add_branch_allocation');
            }
    ...
    public function view_edit_observation($row_id = null)
    {
        ...
        $this->load->view('hougp/edit_observation', $data);
    }
    ...
    public function view_edit_punishment($row_id = null)
    {
        ...
        $this->load->view('hougp/edit_punishment', $data);
    }
    ...
    public function view_activity_log()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('hougp/activity_log', $data);
        }
    }
    ...
    public function search_excuse_by_date()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $view_page = $this->load->view('hougp/view_excuse_list', $data, TRUE);
            echo $view_page;
            json_encode($view_page);
        }
    }
        ...
        if ($this->input->post()) {
            ...
            if (!empty($insert)) {
                ...
                if ($postData['pagee'] == 'milestone_list') {
                    $this->session->set_flashdata('success', 'Data Submitted successfully');
                    redirect('HOUGP/view_milestone_list');
                    ...
                    $this->session->set_flashdata('success', 'Data Submitted successfully');
                    redirect('HOUGP/add_physical_milestone');
                }
            } else {
    ...
    public function view_edit_qualities($p_id = null)
    {
        ...
        $this->load->view('hougp/edit_officer_like_qualities', $data);
    }
    ...
    public function save_officer_qualities()
    {
        ...
        if (!empty($insert)) {
            $this->session->set_flashdata('success', 'Data Submitted successfully');
            redirect('HOUGP/add_officer_qualities');
        } else {
            $this->session->set_flashdata('failure', 'Something went wrong, try again.');
            redirect('HOUGP/add_officer_qualities');
        }
    ...
    public function punishment_records_report($oc_no = NULL, $term = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            // echo $term; exit;
            $data['term'] = $term;
            $html = $this->load->view('hougp/punishment_report', $data, TRUE); //$graph, TRUE);
    ...
    public function observation_records_report($oc_no = NULL, $term = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $data['term'] = $term;
            $html = $this->load->view('hougp/observation_report', $data, TRUE); //$graph, TRUE);
    ...
    public function warning_records_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $data['term'] = $term;
            $html = $this->load->view('hougp/warning_report', $data, TRUE); //$graph, TRUE);
    ...
    public function inspection_records_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $data['term'] = $term;
            $html = $this->load->view('hougp/inspection_report', $data, TRUE); //$graph, TRUE);
    ...
    public function medical_records_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $data['medical_records'] = $this->db->get()->result_array();
            $html = $this->load->view('hougp/medical_report', $data, TRUE); //$graph, TRUE);
    ...
    public function saluting_swimming_records_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('hougp/saluting_swimming_report', $data, TRUE); //$graph, TRUE);
    ...
    public function physical_efficiency_records_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('hougp/physical_efficiency_report', $data, TRUE); //$graph, TRUE);
    ...
    public function officer_qualities_records_report($oc_no = NULL, $term = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('hougp/officer_qualities_report', $data, TRUE); //$graph, TRUE);
    ...
    public function personal_data_records_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('hougp/personal_data_report', $data, TRUE); //$graph, TRUE);
    ...
    public function divisional_officer_records_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('hougp/divisional_officer_record_report', $data, TRUE); //$graph, TRUE);
    ...
    public function autobiography_record_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('hougp/autobiography_record_report', $data, TRUE); //$graph, TRUE);
    ...
    public function psychology_record_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('hougp/psychology_record_report', $data, TRUE); //$graph, TRUE);
    ...
    public function result_record_report($oc_no = NULL, $term = NULL, $doc_type = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('hougp/result_record_report', $data, TRUE); //$graph, TRUE);
    ...
    public function general_remarks_report($oc_no = NULL, $term = NULL, $type = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('hougp/general_remarks_report', $data, TRUE); //$graph, TRUE);
    ...
    public function progress_chart_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('hougp/progress_chart_report', $data, TRUE); //$graph, TRUE);
    ...
    public function distinction_achieved_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('hougp/distinction_achieved_report', $data, TRUE); //$graph, TRUE);
    ...
    public function seniority_record_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('hougp/seniority_record_report', $data, TRUE); //$graph, TRUE);
    ...
    public function branch_allocation_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('hougp/branch_allocation_report', $data, TRUE);
    ...
    public function warning_record_insert_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('hougp/warning_insert_report', $data, TRUE);
    ...
    {
        $this->load->view('hougp/Results');
    }

    public function view_semester_result()
    {
        $this->load->view('hougp/add_semester_result');
    }
    ...
    public function view_promotion_screen()
    {
        ...
        $this->load->view('hougp/term_promotion', $data);
    }
    ...
    public function view_edit_psychologist_report($id = null)
    {
        ...
        $this->load->view('hougp/edit_psychologist_report', $data);
    }
    ...
    public function save_psychologist_report()
    {
        ...
        if (!empty($insert)) {
            $this->session->set_flashdata('success', 'Data Submitted successfully');
            redirect('HOUGP/psychologist_report');
        } else {
            $this->session->set_flashdata('failure', 'Something went wrong, try again.');
            redirect('HOUGP/add_officer_qualities');
        }
    ...
    public function view_edit_biography($p_id = null)
    {
        ...
        //$this->load->view('hougp/edit_inspection_record', $data);
        $this->load->view('hougp/edit_cadet_autobiography', $data);
    }
    ...
    public function save_general_remarks()
    {
        ...
        if (!empty($insert)) {
            $this->session->set_flashdata('success', 'Data Submitted successfully');
            redirect('HOUGP/view_general_remarks');
        } else {
            $this->session->set_flashdata('failure', 'Something went wrong, try again.');
            redirect('HOUGP/view_general_remarks');
        }
    ...
    public function save_cadet_progress()
    {
        ...
        if (!empty($insert) || !empty($update)) {
            $this->session->set_flashdata('success', 'Data Submitted successfully');
            redirect('HOUGP/view_progress_chart');
        } else {
            $this->session->set_flashdata('failure', 'Something went wrong, try again.');
            redirect('HOUGP/view_progress_chart');
        }
    ...
    public function save_cadet_semester_result()
    {
        ...
        if (!empty($insert) || !empty($update)) {
            $this->session->set_flashdata('success', 'Data Submitted successfully');
            redirect('HOUGP/view_semester_result');
        } else {
            $this->session->set_flashdata('failure', 'Something went wrong, try again.');
            redirect('HOUGP/view_semester_result');
        }
    ...
    public function save_cadet_seniority_record()
    {
        ...
        if (!empty($insert) || !empty($update)) {
            $this->session->set_flashdata('success', 'Data Submitted successfully');
            redirect('HOUGP/view_seniority_records');
        } else {
            $this->session->set_flashdata('failure', 'Something went wrong, try again.');
            redirect('HOUGP/view_seniority_records');
        }
    ...
    public function save_distinction_records()
    {
        ...
        if (!empty($insert)) {
            $this->session->set_flashdata('success', 'Data Submitted successfully');
            redirect('HOUGP/view_distinction_records');
        } else {
            $this->session->set_flashdata('failure', 'Something went wrong, try again.');
            redirect('HOUGP/view_distinction_records');
        }
