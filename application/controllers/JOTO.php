...
class JOTO extends CI_Controller
{
    ...
    public function PN_Form()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('joto/pn_form1', $data);
        }
    }
    ...
    public function view_edit_inspection($id = null)
    {
        ...
        $this->load->view('joto/edit_inspection_record', $data);
    }
    ...
    public function view_edit_personal_record($id = null)
    {
        ...
        $this->load->view('joto/edit_personal_data', $data);
    }
    ...
    public function add_inspection_record()
    {
        if ($this->input->post()) {
            ...
            if (!empty($insert)) {
                $this->session->set_flashdata('success', 'Data Submitted successfully');
                redirect('JOTO/Inspection_record');
            } else {
                $this->session->set_flashdata('failure', 'Something went wrong, try again.');
                redirect('JOTO/Inspection_record');
            }
    ...
    public function update_inspection_record()
    {
        if ($this->input->post()) {
            ...
            if (!empty($insert)) {
                ...
                redirect('JOTO/view_dossier_folder');
            } else {
                $this->session->set_flashdata('failure', 'Something went wrong, try again.');
                redirect('JOTO/view_dossier_folder');
            }
        ...
        if ($this->input->post()) {
            ...
            if (!empty($update)) {
                ...
                if ($page == 'daily_module' || $page == 'update_punishment') {
                    redirect('JOTO/view_punishment_list');
                } elseif ($page == 'dossier') {
                    redirect('JOTO/view_dossier');
                }
            } else {
        ...
        if ($this->input->post()) {
            ...
            if (!empty($insert)) {
                if ($page == 'daily_module') {
                    ...
                    redirect('JOTO/view_observation_list');
                } elseif ($page == 'dossier') {
                    $this->session->set_flashdata('success', 'Observation updated successfully');
                    redirect('JOTO/view_dossier');
                } else {
    ...
    public function view_edit_officer_record($row_id = null)
    {
        ...
        $this->load->view('joto/edit_officer_record', $data);
    }
    ...
    public function save_divisional_officer_records()
    {
        if ($this->input->post()) {
            ...
            if (!empty($insert)) {
                ...
                redirect('JOTO/view_record_div_officer');
            } else {
                $this->session->set_flashdata('failure', 'Something went wrong, try again.');
                redirect('JOTO/view_record_div_officer');
            }
    ...
    public function Inspection_record()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('joto/inspection_record', $data);
        }
    }
    ...
    {
        if ($this->session->has_userdata('user_id')) {
            $this->load->view('joto/psychologist_report');
        }
    }
    ...
    public function personal_data()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $data['divisions'] = $this->db->where('division_name', $this->session->userdata('division'))->get('divisions')->result_array();
            $this->load->view('joto/personal_data', $data);
        }
    }
    ...
    public function view_dossier()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            // print_r($data);
            $this->load->view('joto/view_dossier', $data);
        }
    }
    ...
    public function view_dossier_folder()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('joto/view_dossier_folder', $data);
        }
    }
    ...
    public function add_club()
    {
        if ($this->session->has_userdata('user_id')) {
            $data['club_data'] = $this->db->get('cadet_club')->result_array();
            $this->load->view('joto/add_club', $data);
        }
    }
    public function daily_module()
    {
        if ($this->session->has_userdata('user_id')) {
            $this->load->view('joto/daily_module');
        }
    }
    public function add_punishment()
    {
        if ($this->session->has_userdata('user_id')) {
            $this->load->view('joto/add_punishment');
        }
    }
    public function add_physical_milestone($page = null)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('joto/add_physical_milestone', $data);
        }
    }
    public function add_excuse()
    {
        if ($this->session->has_userdata('user_id')) {
            $this->load->view('joto/add_excuse'); //, $data);
        }
    }
    public function add_observation()
    {
        if ($this->session->has_userdata('user_id')) {
            $this->load->view('joto/add_observation');
        }
    }
    public function add_observation_slip()
    {
        if ($this->session->has_userdata('user_id')) {
            $this->load->view('joto/add_observation_slip');
        }
    }
    public function add_warning()
    {
        if ($this->session->has_userdata('user_id')) {
            $this->load->view('joto/add_warning');
        }
    }
    public function add_officer_qualities()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('joto/officer_like_qualities', $data);
        }
    }
    ...
    public function add_branch_allocation()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('joto/branch_allocation', $data);
        }
    }
    public function save_branches_allocation()
    {
        if ($this->input->post()) {
            ...
            if (!empty($insert)) {
                ...
                redirect('JOTO/add_branch_allocation');
            } else {
                $this->session->set_flashdata('failure', 'Something went wrong, try again.');
                redirect('JOTO/add_branch_allocation');
            }
...
$branch_id='';
    ...
    public function view_punishment_list()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('joto/view_punishment_list', $data);
        }
    }
    ...
    public function view_edit_warning($row_id = null)
    {
        ...
        $this->load->view('joto/edit_warning', $data);
    }
    ...
    public function view_edit_observation($row_id = null)
    {
        ...
        $this->load->view('joto/edit_observation', $data);
    }
    ...
    public function view_edit_punishment($row_id = null)
    {
        ...
        $this->load->view('joto/edit_punishment', $data);
    }
    ...
    public function view_excuse_list()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('joto/view_excuse_list', $data);
        }
    }
    public function view_observation_list()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->db->where('f.unit_id', $this->session->userdata('unit_id'));
            $data['observation_records'] = $this->db->get()->result_array();
            $this->load->view('joto/view_observation_list', $data);
        }
    }
    ...
    public function view_activity_log()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $this->load->view('joto/activity_log', $data);
        }
    }
    ...
    public function view_milestone_list()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $data['milestone_records'] = $this->db->get()->result_array();
            // print_r( $data['milestone_records']);exit;
            $this->load->view('joto/view_milestone_list', $data);
        }
    }
    ...
    public function search_excuse_by_date()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $view_page = $this->load->view('joto/view_excuse_list', $data, TRUE);
            echo $view_page;
            json_encode($view_page);
        }
    }
    ...
    public function search_punish_by_date()
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $data['punishment_records'] = $this->db->get()->result_array();
            $data['search_date'] = $date;
            $view_page = $this->load->view('joto/view_punishment_list', $data, TRUE);
            echo $view_page;
            json_encode($view_page);
        }
    }
        ...
        if ($this->input->post()) {
            ...
            if (!empty($insert)) {
                ...
                if ($postData['pagee'] == 'milestone_list') {
                    $this->session->set_flashdata('success', 'Data Submitted successfully');
                    redirect('JOTO/view_milestone_list');
                    ...
                    $this->session->set_flashdata('success', 'Data Submitted successfully');
                    redirect('JOTO/add_physical_milestone');
                }
            } else {
    ...
    public function view_edit_qualities($p_id = null)
    {
        ...
        $this->load->view('joto/edit_officer_like_qualities', $data);
    }
    ...
    public function save_officer_qualities()
    {
        ...
        if (!empty($insert)) {
            $this->session->set_flashdata('success', 'Data Submitted successfully');
            redirect('JOTO/add_officer_qualities');
        } else {
            $this->session->set_flashdata('failure', 'Something went wrong, try again.');
            redirect('JOTO/add_officer_qualities');
        }
    ...
    public function punishment_records_report($oc_no = NULL, $term = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            // echo $term; exit;
            $data['term'] = $term;
            $html = $this->load->view('joto/punishment_report', $data, TRUE); //$graph, TRUE);
    ...
    public function observation_records_report($oc_no = NULL, $term = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $data['term'] = $term;
            $html = $this->load->view('joto/observation_report', $data, TRUE); //$graph, TRUE);
    ...
    public function warning_records_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $data['term'] = $term;
            $html = $this->load->view('joto/warning_report', $data, TRUE); //$graph, TRUE);
    ...
    public function inspection_records_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $data['term'] = $term;
            $html = $this->load->view('joto/inspection_report', $data, TRUE); //$graph, TRUE);
    ...
    public function medical_records_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $data['medical_records'] = $this->db->get()->result_array();
            $html = $this->load->view('joto/medical_report', $data, TRUE); //$graph, TRUE);
    ...
    public function saluting_swimming_records_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('joto/saluting_swimming_report', $data, TRUE); //$graph, TRUE);
    ...
    public function physical_efficiency_records_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('joto/physical_efficiency_report', $data, TRUE); //$graph, TRUE);
    ...
    public function officer_qualities_records_report($oc_no = NULL, $term = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('joto/officer_qualities_report', $data, TRUE); //$graph, TRUE);
    ...
    public function personal_data_records_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('joto/personal_data_report', $data, TRUE); //$graph, TRUE);
    ...
    public function divisional_officer_records_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('joto/divisional_officer_record_report', $data, TRUE); //$graph, TRUE);
    ...
    public function autobiography_record_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('joto/autobiography_record_report', $data, TRUE); //$graph, TRUE);
    ...
    public function psychology_record_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('joto/psychology_record_report', $data, TRUE); //$graph, TRUE);
    ...
    public function result_record_report($oc_no = NULL, $term = NULL, $doc_type = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('joto/result_record_report', $data, TRUE); //$graph, TRUE);
    ...
    public function general_remarks_report($oc_no = NULL, $term = NULL, $type = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('joto/general_remarks_report', $data, TRUE); //$graph, TRUE);
    ...
    public function progress_chart_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('joto/progress_chart_report', $data, TRUE); //$graph, TRUE);
    ...
    public function distinction_achieved_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('joto/distinction_achieved_report', $data, TRUE); //$graph, TRUE);
    ...
    public function seniority_record_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('joto/seniority_record_report', $data, TRUE); //$graph, TRUE);
    ...
    public function branch_allocation_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('joto/branch_allocation_report', $data, TRUE);
    ...
    public function warning_record_insert_report($oc_no = NULL)
    {
        if ($this->session->has_userdata('user_id')) {
            ...
            $html = $this->load->view('joto/warning_insert_report', $data, TRUE);
    ...
    {
        $this->load->view('joto/Results');
    }
    public function view_semester_result()
    {
        $this->load->view('joto/add_semester_result');
    }
    ...
    public function view_promotion_screen()
    {
        ...
        $this->load->view('joto/term_promotion', $data);
    }
    ...
    public function view_edit_psychologist_report($id = null)
    {
        ...
        $this->load->view('joto/edit_psychologist_report', $data);
    }
    ...
    public function save_psychologist_report()
    {
        ...
        if (!empty($insert)) {
            $this->session->set_flashdata('success', 'Data Submitted successfully');
            redirect('JOTO/psychologist_report');
        } else {
            $this->session->set_flashdata('failure', 'Something went wrong, try again.');
            redirect('JOTO/add_officer_qualities');
        }
    ...
    public function view_edit_biography($p_id = null)
    {
        ...
        //$this->load->view('joto/edit_inspection_record', $data);
        $this->load->view('joto/edit_cadet_autobiography', $data);
    }
    ...
    public function save_general_remarks()
    {
        ...
        if (!empty($insert)) {
            $this->session->set_flashdata('success', 'Data Submitted successfully');
            redirect('JOTO/view_general_remarks');
        } else {
            $this->session->set_flashdata('failure', 'Something went wrong, try again.');
            redirect('JOTO/view_general_remarks');
        }
    ...
    public function save_cadet_progress()
    {
        ...
        if (!empty($insert) || !empty($update)) {
            $this->session->set_flashdata('success', 'Data Submitted successfully');
            redirect('JOTO/view_progress_chart');
        } else {
            $this->session->set_flashdata('failure', 'Something went wrong, try again.');
            redirect('JOTO/view_progress_chart');
        }
    ...
    public function save_cadet_semester_result()
    {
        ...
        if (!empty($insert) || !empty($update)) {
            $this->session->set_flashdata('success', 'Data Submitted successfully');
            redirect('JOTO/view_semester_result');
        } else {
            $this->session->set_flashdata('failure', 'Something went wrong, try again.');
            redirect('JOTO/view_semester_result');
        }
    ...
    public function save_cadet_seniority_record()
    {
        ...
        if (!empty($insert) || !empty($update)) {
            $this->session->set_flashdata('success', 'Data Submitted successfully');
            redirect('JOTO/view_seniority_records');
        } else {
            $this->session->set_flashdata('failure', 'Something went wrong, try again.');
            redirect('JOTO/view_seniority_records');
        }
    ...
    public function save_distinction_records()
    {
        ...
        if (!empty($insert)) {
            $this->session->set_flashdata('success', 'Data Submitted successfully');
            redirect('JOTO/view_distinction_records');
        } else {
            $this->session->set_flashdata('failure', 'Something went wrong, try again.');
            redirect('JOTO/view_distinction_records');
        }
