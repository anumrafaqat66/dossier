...
<div class="container-fluid my-2">
    ...
    <div class="form-group row justify-content-center">
        ...
        <div class="col-lg-11">
            <h1 style="text-align:center; padding:40px"><strong>ADD SEMESTER RESULT</strong></h1>
        </div>
        ...
        <div id="search_cadet" class="row my-2" style="display:none">
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body bg-custom3">
                        <form class="user" role="form" method="post" enctype="multipart/form-data" id="save_form" action="<?= base_url(); ?>HOUGP/save_cadet_semester_result">
                            <div class="form-group row">
                                <div class="col-sm-4">
                                    <h6>&nbsp;Name:</h6>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3 mb-1">
                                    <input type="number" class="form-control form-control-user" name="gpa_t1" id="gpa_t1" placeholder="Enter GPA">
                                </div>
                                <div class="col-sm-3 mb-1">
                                ...
                                <div class="col-sm-3 mb-1">
                                    <input type="number" class="form-control form-control-user" name="gpa_t5" id="gpa_t5" placeholder="Enter GPA">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-3 mb-1">
                                ...
                                <div class="col-sm-3 mb-1">
                                    <input type="number" class="form-control form-control-user" name="gpa_t2" id="gpa_t2" placeholder="Enter GPA">
                                </div>
                                <div class="col-sm-3 mb-1">
                                ...
                                <div class="col-sm-3 mb-1">
                                    <input type="number" class="form-control form-control-user" name="gpa_t6" id="gpa_t6" placeholder="Enter GPA">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-3 mb-1">
                                ...
                                <div class="col-sm-3 mb-1">
                                    <input type="number" class="form-control form-control-user" name="gpa_t3" id="gpa_t3" placeholder="Enter GPA">
                                </div>
                                <div class="col-sm-3 mb-1">
                                ...
                                <div class="col-sm-3 mb-1">
                                    <input type="number" class="form-control form-control-user" name="gpa_t7" id="gpa_t7" placeholder="Enter GPA">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-3 mb-1">
                                ...
                                <div class="col-sm-3 mb-1">
                                    <input type="number" class="form-control form-control-user" name="gpa_t4" id="gpa_t4" placeholder="Enter GPA">
                                </div>
                                <div class="col-sm-3 mb-1">
                                ...
                                <div class="col-sm-3 mb-1">
                                    <input type="number" class="form-control form-control-user" name="gpa_t8" id="gpa_t8" placeholder="Enter GPA">
                                </div>
                            </div>
...
<script>
    ...
    $('#add_btn').on('click', function() {
        ...
        if (validate == 0) {
            ...
            if ($('#name').val() != null) {
                $.ajax({
                    url: '<?= base_url(); ?>HOUGP/get_semester_results_values',
                    method: 'POST',
                    data: {
                        'p_id': $('#id').val()
                    },
