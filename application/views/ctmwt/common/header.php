...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url(); ?>CTMWT/view_dossier_folder" aria-expanded="true">
            ...
            <li class="nav-item">
                ...
                <div id="collapse_general" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?php echo base_url(); ?>CTMWT/add_club">Add Club</a>
                        <a class="collapse-item" href="<?php echo base_url(); ?>CTMWT/Inspection_record">Inspection Record</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapse_discipline" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?php echo base_url(); ?>CTMWT/daily_module">Daily Module</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapse_warning" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?php echo base_url(); ?>CTMWT/add_warning">Add Warning</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapse_academic" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?= base_url(); ?>CTMWT/view_semester_result"><?php if ($this->session->userdata('unit_id') != '1') { ?>Results (Terms VI - VIII)<?php } else { ?> Results (Terms I - III) <?php } ?></a>
            ...
            <li class="nav-item">
                ...
                <div id="collapse_assesment" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?= base_url(); ?>CTMWT/view_general_remarks">General Remarks</a>
                        <a class="collapse-item" href="<?= base_url(); ?>CTMWT/view_progress_chart">Progress Chart</a>
                        <a class="collapse-item" href="<?= base_url(); ?>CTMWT/view_distinction_records">Distictions</a>
                        <a class="collapse-item" href="<?= base_url(); ?>CTMWT/view_seniority_records">Seniority</a>
                        <a class="collapse-item" href="<?php echo base_url(); ?>CTMWT/add_branch_allocation">Branch Allocation</a>
                        <a class="collapse-item" href="#">Degree Complete</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url(); ?>CTMWT/add_officer_qualities" aria-expanded="true">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url(); ?>CTMWT/view_promotion_screen" aria-expanded="true">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="<?php echo base_url(); ?>CTMWT/view_activity_log" aria-expanded="true">
