...
<div class="container-fluid my-4">
    ...
    $dataPoints2 = array(
        ...
        array("label" => "Assault Qualified", "y" => ($assault_result['count'] / $Total_cadet['count']) * 100),
        array("label" => "Saluting Qualified", "y" => ($saluting_result['count'] / $Total_cadet['count']) * 100),
    ...
    $dataPoints_t1 = array(
        ...
        array("label" => "Assault", "y" => ($assault_result_t1['count'] / $Total_cadet_t1['count']) * 100),
        array("label" => "Saluting", "y" => ($saluting_result_t1['count'] / $Total_cadet_t1['count']) * 100),
        array("label" => "PLX", "y" => ($PLX_result_t1['count'] / $Total_cadet_t1['count']) * 100),
        array("label" => "Long Cross", "y" => ($long_cross_result_t1['count'] / $Total_cadet_t1['count']) * 100),
        array("label" => "Mini Cross", "y" => ($mini_cross_result_t1['count'] / $Total_cadet_t1['count']) * 100)
    );
    $dataPoints_t2 = array(
        ...
        array("label" => "Assault", "y" => ($assault_result_t2['count'] / $Total_cadet_t2['count']) * 100),
        array("label" => "Saluting", "y" => ($saluting_result_t2['count'] / $Total_cadet_t2['count']) * 100),
        array("label" => "PLX", "y" => ($PLX_result_t2['count'] / $Total_cadet_t2['count']) * 100),
        array("label" => "Long Cross", "y" => ($long_cross_result_t2['count'] / $Total_cadet_t2['count']) * 100),
        array("label" => "Mini Cross", "y" => ($mini_cross_result_t2['count'] / $Total_cadet_t2['count']) * 100)
    );
    $dataPoints_t3 = array(
        ...
        array("label" => "Assault", "y" => ($assault_result_t3['count'] / $Total_cadet_t3['count']) * 100),
        array("label" => "Saluting", "y" => ($saluting_result_t3['count'] / $Total_cadet_t3['count']) * 100),
        array("label" => "PLX", "y" => ($PLX_result_t3['count'] / $Total_cadet_t3['count']) * 100),
        array("label" => "Long Cross", "y" => ($long_cross_result_t3['count'] / $Total_cadet_t3['count']) * 100),
        array("label" => "Mini Cross", "y" => ($mini_cross_result_t3['count'] / $Total_cadet_t3['count']) * 100)
    );
    ?>
</div>
