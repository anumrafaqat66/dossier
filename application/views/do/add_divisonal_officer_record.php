...
<div class="container-fluid my-2">
    ...
    <div class="form-group row justify-content-center">
        ...
        <div class="col-lg-11">
            <h1 style="text-align:center; padding:40px"><strong>ADD DIVISIONAL OFFICER RECORD</strong></h1>
        </div>
        ...
        <div id="search_cadet" class="row my-2" style="display:none">
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body bg-custom3">
                        <form class="user" role="form" method="post" enctype="multipart/form-data" id="save_form" action="<?= base_url(); ?>D_O/save_divisional_officer_records">
                            <div class="form-group row">
                                <div class="col-sm-4">
                                    <h6>&nbsp;Name:</h6>
                                </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 mb-1">
                                    <input type="date" class="form-control form-control-user" name="date_from" id="date_from">
                                </div>
                                <div class="col-sm-6 mb-1">
