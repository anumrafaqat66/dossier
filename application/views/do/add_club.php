...
<div class="container-fluid my-2">
    ...
    <div class="card-body" style="padding:10px">
        ...
        <div class="card-body" style="margin-bottom:20px;float:right; padding:30px; margin-right:500px">
            <h1 style="text-align:center"><strong>ADD CADET TO CLUB</strong></h1>
        </div>
    </div>
        ...
        <div id="search_cadet" class="row my-2" style="display:none">
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body bg-custom3">
                        <form class="user" role="form" method="post" id="save_form" action="<?= base_url(); ?>D_O/save_cadet_club">
                            <div class="form-group row">
                                <div class="col-sm-3">
                                    <h6>&nbsp;Name:</h6>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3 mb-1">
                                    <select class="form-control rounded-pill" name="club" id="club" data-placeholder="Select Contractor" style="font-size: 0.8rem; height:50px; font-weight: bold; font-size:large">
