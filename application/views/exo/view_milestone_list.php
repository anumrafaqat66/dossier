        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                        <a onclick="location.href='<?php echo base_url(); ?>EXO/add_physical_milestone/milestone_list'" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" style="float:right;margin-right:4px" data-toggle="modal" data-target="#all_projects"><i class="fas fa-plus-circle fa-sm text-white-60"></i> Add New Record </a>
                        </div>
                    </div>
...
<script>
    ...
    $('#search_btn').on('click', function() {
        ...
        if (validate == 0) {
            ...
            $.ajax({
                url: '<?= base_url(); ?>EXO/search_punish_by_date',
                method: 'POST',
                data: {
